...
describe("CredentialRegistry", function () {
  ...
  describe("Issuer Management", function () {
    ...
    it("Should emit IssuerApproved event when disapproving issuer", async function () {
      await expect(credentialRegistry.approveIssuer(issuerA.address, false))
        .to.emit(credentialRegistry, "IssuerApproved")
        .withArgs(issuerA.address, false);
    });
